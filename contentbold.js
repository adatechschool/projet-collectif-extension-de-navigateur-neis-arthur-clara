...
function formatWordsInTabs() {
    const allParagraphs = document.querySelectorAll("p, li, strong, em, a, h1, h2, h3, ul, label, span, cite, b, i"); //récupération de tous les paragraphes du HTML + li
...
function removeWordFormatting() {
    const allSpans = document.querySelectorAll("p > span, li > span, strong > span, em > span, a > span, h1 > span, h2 > span, h3 > span, ul > span, label > span, span > span, cite > span, b > span, i> span"); //sélection de tous les enfants de p (et autres) qui sont des span crée dans le formatWordsInTabs
